                  ...
                  <tr key={l.id} className="hover:bg-muted/30 transition-colors">
                    ...
                    <td className="px-4 py-3">
                      <div className="flex flex-col">
                        {((l as any).lead_id || (l.entity_type === 'lead' && (l as any).entity_id)) ? (
                          <a href={`/leads/${(l as any).lead_id || (l as any).entity_id}`} className="font-medium text-violet-600 hover:text-violet-700 hover:underline">
                            {l.contact_name || '—'}
                          </a>
                        ) : (
